...
/**
 * @see <a href="https://github.com/mybatis/spring-boot-starter/wiki/MyBatisNativeConfiguration.java">MyBatisNativeConfiguration</a>
 */
        ...
        private void resolveMapperFactoryBeanTypeIfNecessary(RootBeanDefinition beanDefinition) {
            ...
            if (beanDefinition.getResolvableType().hasUnresolvableGenerics()) {
                ...
                if (mapperInterface != null) {
                    ...
                    //
                    // fixed error: Parameter 0 of constructor in org.mybatis.spring.mapper.MapperFactoryBean required a bean of type 'java.lang.Class' that could not be found.
                    // resolved by: https://github.com/baomidou/mybatis-plus/issues/5826
                    //
